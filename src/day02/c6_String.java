...
public class c6_String {
    ...
    public static void main(String [] args){
        ...
        System.out.println(salary + 10 ); // 110010.00 both variables is number so it will sum borh
        System.out.println(number + 10 ); // 1100000+10 since you have string it is going to concat
        ...
        System.out.println(s1+i1); // 7(word) +7(number)
    ...
    // print those age with person  name Alia age is 20
