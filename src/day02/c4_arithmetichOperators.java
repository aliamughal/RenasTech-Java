...
public class c4_arithmetichOperators {
    ...
    public static void main (String [] args){
        ...
        System.out.println(20.0/10); //2.0 in here you have double number (decimal number 20.0) result also should be
        ...
        System.out.println(10%2); // reminder is 0 here

        System.out.println(10/3); // this will return 3
